...
export class UserService {
  ...
  getEducatorData(id: number) {
    return this.http.get(`${this.educatorsURL}/${id}`, {
      observe: 'response',
      headers: this.headers,
    });
  }
  ...
  updateAdminCredentials(data: any, id: number) {
    return this.http.put(`${this.adminURL}/${id}/${'credentials'}`, data, {
      observe: 'response',
      headers: this.headers,
    });
  }
  ...
  updateEducatorCredentials(data: any, id: number) {
    return this.http.put(`${this.educatorsURL}/${id}/${'credentials'}`, data, {
      observe: 'response',
      headers: this.headers,
    });
  }
  ...
  updateAdminData(data: any, id: number) {
    return this.http.put(`${this.adminURL}/${id}/${'data'}`, data, {
      observe: 'response',
      headers: this.headers,
    });
  }
